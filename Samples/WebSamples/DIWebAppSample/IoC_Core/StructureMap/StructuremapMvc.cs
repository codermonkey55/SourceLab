...
using IoCHandler = CodeLabs.Web.WebForms.IoC_Integration.IoC_Core.StructureMap.DependencyResolution.IoC;

[assembly: PreApplicationStartMethod(typeof(StructuremapMvc), "Start")]
[assembly: ApplicationShutdownMethod(typeof(StructuremapMvc), "End")]

namespace CodeLabs.Web.WebForms.IoC_Integration.IoC_Core.StructureMap
{
    public static class StructuremapMvc
    {
        ...
        {
            IContainer container = IoCHandler.Initialize();
