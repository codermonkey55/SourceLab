...
// [assembly: System.Web.PreApplicationStartMethodAttribute(typeof(DIWebAppSample.App_Start.DependencyConfig), "PreStart")]

// When Order is not defined it defaults to -1, so -2 is used to make it run first
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(DIWebAppSample.App_Start.DependencyConfig), "PreStart", Order = -2)]
